...
export const T = {
  ...
  home: {
    heroSubtitle: {
      ...
      jp: "コンサルタント、オペレーター、起業家として、日本・韓国・アメリカを渡り歩いてきた。今はアーリーステージの起業家たちへの投資に取り組んでいる。",
    },
    ...
    bioPara1: {
      ...
      jp: "生まれてから20ヶ月のあいだに、韓国・ドイツ・日本の3カ国を渡った。小学校はテネシーとコロラドと韓国、中学はテキサス、高校はソウル。大学でアメリカへ、兵役で韓国へ、就職で日本へ。気がつけば、人生が自分をどんどん次の国へと弾き飛ばし続けていた。そのうちに、いちばん面白いことは人と場所がぶつかるところに転がっているのだと、そう思うようになった。",
    },
    bioPara2: {
      ...
      jp: "キャリアもまた、その境界の上で積んできた。東京でL.E.K.のコンサルタントとして、日韓でシナボンとジャンバジュースの運営者として、アジアで急拡大するホスピタリティ・テックのユニコーン企業でチーフ・オブ・スタッフとして。コロナで事業の全面転換を迫られれば泥臭く現場に入り、ゴディバカフェを含む日本各地のカフェチェーンに卸す自分のティーブランドも立ち上げた。ハーバード・ビジネス・スクールでの2年間は、現場で掴んでいたものに言葉を与えてくれた。",
    },
    bioPara3: {
      ...
      jp: "今は、その境界の上で挑む創業期の起業家たちへの投資に力を入れている。新しいアイデアが交わり、まだ誰も答えを知らない、そんな場所で戦っている人たちだ。",
    },
    ...
    items: [
      ...
      },
      {
        ...
        note: {
          ...
          jp: "アジア全域でグローバルなフードブランドを運営。急成長するホスピタリティ・テックのユニコーン企業でチーフ・オブ・スタッフを務めた。",
        },
      },
      {
        index: "III",
      ...
      },
      {
        ...
        note: {
          ...
          jp: "日本と米国で、創業期の起業家たちへの投資に取り組んでいる。",
        },
      },
    ],
  },
