...
const items = [
  { index: "I",   role: "Strategy Consulting",    org: "Consumer, Pharma & Manufacturing",      note: "Growth strategy, M&A diligence, and financial modeling for companies across APAC and the U.S." },
