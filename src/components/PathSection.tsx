...
const items = [
  ...
  { index: "IV",  role: "Harvard Business School",org: "MBA",                    note: "Co-chair of the HBS Asia Business Conference — one of the largest student-run business conferences in the world." },
