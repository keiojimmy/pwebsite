...
const items = [
  { index: "I",   role: "Strategy Consulting",    org: "Consumer, Pharma & Manufacturing",      note: "M&A diligence, commercial strategy, and financial modeling across Japan and the U.S." },
