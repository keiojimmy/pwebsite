...
const items = [
  ...
  { index: "II",  role: "Operator",               org: "Enterprise & Startups",  note: "Running global food brands across Japan and Korea. Chief of Staff at a fast-growing hospitality tech unicorn." },
